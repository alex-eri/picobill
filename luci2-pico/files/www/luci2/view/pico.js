L.ui.view.extend({
	...
	execute: function() {
		...
		var m = new L.cbi.Map('pico', {
			caption:     L.tr('pico configuration')
		});

		var s = m.section(L.cbi.TypedSection, 'pico.radius.nas', {
			caption:      L.tr('Radius clients'),
			addremove:    true,
			add_caption:  L.tr('Add nas …'),
		});
